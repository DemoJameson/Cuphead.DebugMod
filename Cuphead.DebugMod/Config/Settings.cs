...
public class Settings : PluginComponent {
    ...
    public static ConfigEntry<bool> DevilPhaseThreeSkullPattern;
    ...
    public void Awake() {
        ...
        FrogsPhaseOneFirefliesPatternEasy = config.Bind("RNG Ribby And Croaks", "P1 Fireflies Pattern Simple", FrogsPhaseOneFirefliesPatternsEasy.Random, --order);
        FrogsPhaseOneFirefliesPatternNormal = config.Bind("RNG Ribby And Croaks", "P1 Fireflies Pattern Regular", FrogsPhaseOneFirefliesPatternsNormal.Random, --order);
        FrogsPhaseOneFirefliesPatternHard = config.Bind("RNG Ribby And Croaks", "P1 Fireflies Pattern Expert", FrogsPhaseOneFirefliesPatternsHard.Random, --order);
        ...
        FlowerPhaseGeneric1PatternNormal = config.Bind("RNG Cagney Carnation", "P1 Regular", FlowerPhaseGeneric1PatternsNormal.Random, --order);
        FlowerPhaseGeneric2PatternNormal = config.Bind("RNG Cagney Carnation", "P2 Regular", FlowerPhaseGeneric2PatternsNormal.Random, --order);
        FlowerPhaseGeneric3PatternNormal = config.Bind("RNG Cagney Carnation", "P3 Regular", FlowerPhaseGeneric3PatternsNormal.Random, --order);
        ...
        FlyingBirdPhaseOneDirection = config.Bind("RNG Wally Warbles", "P1 Direction", FlyingBirdPhaseOneDirections.Random, --order);
        FlyingBirdPhaseOnePatternEasy = config.Bind("RNG Wally Warbles", "P1 Pattern Simple", FlyingBirdPhaseOnePatternsEasy.Random, --order);
        FlyingBirdPhaseTwoPatternEasy = config.Bind("RNG Wally Warbles", "P2 Pattern Simple", FlyingBirdPhaseTwoPatternsEasy.Random, --order);
        FlyingBirdPhaseOnePatternNormal = config.Bind("RNG Wally Warbles", "P1 Pattern Regular", FlyingBirdPhaseOnePatternsNormal.Random, --order);
        FlyingBirdPhaseTwoPatternNormal = config.Bind("RNG Wally Warbles", "P2 Pattern Regular", FlyingBirdPhaseTwoPatternsNormal.Random, --order);
        FlyingBirdPhaseThreeDirection = config.Bind("RNG Wally Warbles", "P3 Direction", FlyingBirdPhaseThreeDirections.Random, --order);
        FlyingBirdPhaseOnePatternHard = config.Bind("RNG Wally Warbles", "P1 Pattern Expert", FlyingBirdPhaseOnePatternsHard.Random, --order);
        ...
        FlyingGeniePhaseOneTreasurePattern = config.Bind("RNG Djimmi The Great", "P1 Treasure", FlyingGeniePhaseOneTreasurePatterns.Random, --order);
        FlyingGeniePhaseOneSwordTypeEasyNormal = config.Bind("RNG Djimmi The Great", "P1 Sword Parry Pattern Simple/Regular", FlyingGeniePhaseOneSwordTypesEasyNormal.Random, --order);
        FlyingGeniePhaseOneSwordTypeHard = config.Bind("RNG Djimmi The Great", "P1 Sword Parry Pattern Expert", FlyingGeniePhaseOneSwordTypesHard.Random, --order);
        FlyingGeniePhaseOneGemsTypeEasy = config.Bind("RNG Djimmi The Great", "P1 Gems Parry Pattern Simple", FlyingGeniePhaseOneGemsTypesEasy.Random, --order);
        FlyingGeniePhaseOneGemsTypeNormalHard = config.Bind("RNG Djimmi The Great", "P1 Gems Parry Pattern Regular/Expert", FlyingGeniePhaseOneGemsTypesNormalHard.Random, --order);
        FlyingGeniePhaseOneSphinxType = config.Bind("RNG Djimmi The Great", "P1 Sphinx Parry Pattern", FlyingGeniePhaseOneSphinxTypes.Random, --order);
        FlyingGeniePhaseTwoObeliskPattern = config.Bind("RNG Djimmi The Great", "P2 Face Positions", FlyingGeniePhaseTwoObeliskPatterns.Random, --order);
        ClownDashDelayEasy = config.Bind("RNG Beppi The Clown", "P1 Bumper Delays Simple", ClownDashDelaysEasy.Random, --order);
        ClownDashDelayNormal = config.Bind("RNG Beppi The Clown", "P1 Bumper Delays Regular", ClownDashDelaysNormal.Random, --order);
        ClownDashDelayHard = config.Bind("RNG Beppi The Clown", "P1 Bumper Delays Expert", ClownDashDelaysHard.Random, --order);
        ClownHorseType = config.Bind("RNG Beppi The Clown", "P3 Horse Type", ClownHorseTypes.Random, --order);
        ClownHorseDirection = config.Bind("RNG Beppi The Clown", "P3 Horse Direction", ClownHorseDirections.Random, --order);
        DragonPhaseOnePatternEasy = config.Bind("RNG Grim Matchstick", "P1 Pattern Simple", DragonPhaseOnePatternsEasy.Random, --order);
        DragonPhaseTwoPatternEasy = config.Bind("RNG Grim Matchstick", "P2 Pattern Simple", DragonPhaseTwoPatternsEasy.Random, --order);
        DragonPhaseThreePatternNormal = config.Bind("RNG Grim Matchstick", "P3 Pattern Regular", DragonPhaseThreePatternsNormal.Random, --order);
        DragonPhaseOnePatternHard = config.Bind("RNG Grim Matchstick", "P1 Pattern Expert", DragonPhaseOnePatternsHard.Random, --order);
        DragonPhaseTwoPatternHard = config.Bind("RNG Grim Matchstick", "P2 Pattern Expert", DragonPhaseTwoPatternsHard.Random, --order);
        DragonPhaseOneLaserPatternEasy = config.Bind("RNG Grim Matchstick", "P1 Laser Pattern Simple", DragonPhaseOneLaserPatternsEasy.Random, --order);
        DragonPhaseTwoLaserPatternEasy = config.Bind("RNG Grim Matchstick", "P2 Laser Pattern Simple", DragonPhaseTwoLaserPatternsEasy.Random, --order);
        DragonPhaseOneMeteorPatternEasy = config.Bind("RNG Grim Matchstick", "P1 Meteor Pattern Simple", DragonPhaseOneMeteorPatternsEasy.Random, --order);
        DragonPhaseTwoMeteorPatternEasy = config.Bind("RNG Grim Matchstick", "P2 Meteor Pattern Simple", DragonPhaseTwoMeteorPatternsEasy.Random, --order);
        DragonPhaseOneLaserPatternNormal = config.Bind("RNG Grim Matchstick", "P1 Laser Pattern Regular", DragonPhaseOneLaserPatternsNormal.Random, --order);
        DragonPhaseThreeLaserPatternNormal = config.Bind("RNG Grim Matchstick", "P3 Laser Pattern Regular", DragonPhaseThreeLaserPatternsNormal.Random, --order);
        DragonPhaseTwoMeteorPatternNormal = config.Bind("RNG Grim Matchstick", "P2 Meteor Pattern Regular", DragonPhaseTwoMeteorPatternsNormal.Random, --order);
        DragonPhaseThreeMeteorPatternNormal = config.Bind("RNG Grim Matchstick", "P3 Meteor Pattern Regular", DragonPhaseThreeMeteorPatternsNormal.Random, --order);
        DragonPhaseOneMeteorPatternHard = config.Bind("RNG Grim Matchstick", "P1 Meteor Pattern Expert", DragonPhaseOneMeteorPatternsHard.Random, --order);
        DragonPhaseTwoMeteorPatternHard = config.Bind("RNG Grim Matchstick", "P2 Meteor Pattern Expert", DragonPhaseTwoMeteorPatternsHard.Random, --order);
        DragonPhaseOneLaserPatternHard = config.Bind("RNG Grim Matchstick", "P1 Laser Pattern Expert", DragonPhaseOneLaserPatternsHard.Random, --order);
        DragonPhaseTwoLaserPatternHard = config.Bind("RNG Grim Matchstick", "P2 Laser Pattern Expert", DragonPhaseTwoLaserPatternsHard.Random, --order);
        BeePhaseTwoPatternEasy = config.Bind("RNG Rumor Honeybottoms", "P2 Simple", BeePhaseTwoPatternsEasy.Random, --order);
        BeePhaseTwoPatternNormal = config.Bind("RNG Rumor Honeybottoms", "P2 Regular", BeePhaseTwoPatternsNormal.Random, --order);
        BeePhaseTwoPatternHard = config.Bind("RNG Rumor Honeybottoms", "P2 Expert", BeePhaseTwoPatternsHard.Random, --order);
        BeePhaseTwoOrbsDirection = config.Bind("RNG Rumor Honeybottoms", "P2 Orbs Direction", BeePhaseTwoOrbsDirections.Random, --order);
        BeePhaseTwoTrianglesDirection = config.Bind("RNG Rumor Honeybottoms", "P2 Triangles Direction", BeePhaseTwoTrianglesDirections.Random, --order);
        ...
        SallyStageplayPatternEasy = config.Bind("RNG Sally Stageplay", "P1 Simple", SallyStageplayPatternsEasy.Random, --order);
        SallyStageplayPatternNormalHard = config.Bind("RNG Sally Stageplay", "P1 Regular/Expert", SallyStageplayPatternsNormalHard.Random, --order);
        SallyStageplayJumpCountEasy = config.Bind("RNG Sally Stageplay", "P1 Jump Count Simple", SallyStageplayJumpCountsEasy.Random, --order);
        SallyStageplayJumpCountNormalHard = config.Bind("RNG Sally Stageplay", "P1 Jump Count Regular/Expert", SallyStageplayJumpCountsNormalHard.Random, --order);
        SallyStageplayJumpTypeEasy = config.Bind("RNG Sally Stageplay", "P1 Jump Type Simple", SallyStageplayJumpTypesEasy.Random, --order);
        SallyStageplayJumpTypeNormalHard = config.Bind("RNG Sally Stageplay", "P1 Jump Type Regular/Expert", SallyStageplayJumpTypesNormalHard.Random, --order);
        SallyStageplayTeleportOffsetEasy = config.Bind("RNG Sally Stageplay", "P1 Teleport Offset Simple", SallyStageplayTeleportOffsetsEasy.Random, --order);
        SallyStageplayTeleportOffsetNormalHard = config.Bind("RNG Sally Stageplay", "P1 Teleport Offset Regular/Expert", SallyStageplayTeleportOffsetsNormalHard.Random, --order);
        MousePhaseOnePatternEasy = config.Bind("RNG Werner Werman", "P1 Simple", MousePhaseOnePatternsEasy.Random, --order);
        MousePhaseOnePatternNormal = config.Bind("RNG Werner Werman", "P1 Regular", MousePhaseOnePatternsNormal.Random, --order);
        MousePhaseOnePatternHard = config.Bind("RNG Werner Werman", "P1 Expert", MousePhaseOnePatternsHard.Random, --order);
        PiratePhaseThreeGunPatternEasy = config.Bind("RNG Captain Brineybeard", "P3 Gun Simple", PiratePhaseThreeGunPatternsEasy.Random, --order);
        PiratePhaseFourGunPatternEasy = config.Bind("RNG Captain Brineybeard", "P4 Gun Simple", PiratePhaseFourGunPatternsEasy.Random, --order);
        PiratePhaseSevenGunPatternEasy = config.Bind("RNG Captain Brineybeard", "P7 Gun Simple", PiratePhaseSevenGunPatternsEasy.Random, --order);
        PiratePhaseOneGunPatternNormal = config.Bind("RNG Captain Brineybeard", "P1 Gun Regular", PiratePhaseOneGunPatternsNormal.Random, --order);
        PiratePhaseTwoGunPatternNormal = config.Bind("RNG Captain Brineybeard", "P2 Gun Regular", PiratePhaseTwoGunPatternsNormal.Random, --order);
        PiratePhaseThreeGunPatternNormal = config.Bind("RNG Captain Brineybeard", "P3 Gun Regular", PiratePhaseThreeGunPatternsNormal.Random, --order);
        PiratePhaseOneGunPatternHard = config.Bind("RNG Captain Brineybeard", "P1 Gun Expert", PiratePhaseOneGunPatternsHard.Random, --order);
        PiratePhaseTwoGunPatternHard = config.Bind("RNG Captain Brineybeard", "P2 Gun Expert", PiratePhaseTwoGunPatternsHard.Random, --order);
        PiratePhaseThreeGunPatternHard = config.Bind("RNG Captain Brineybeard", "P3 Gun Expert", PiratePhaseThreeGunPatternsHard.Random, --order);
        PiratePhaseFourPatternEasy = config.Bind("RNG Captain Brineybeard", "P4 Simple", PiratePhaseFourPatternsEasy.Random, --order);
        PiratePhaseSevenPatternEasy = config.Bind("RNG Captain Brineybeard", "P7 Simple", PiratePhaseSevenPatternsEasy.Random, --order);
        PiratePhaseTwoPatternNormalHard = config.Bind("RNG Captain Brineybeard", "P2 Regular/Expert", PiratePhaseTwoPatternsNormalHard.Random, --order);
        PiratePhaseThreePatternNormalHard = config.Bind("RNG Captain Brineybeard", "P3 Regular/Expert", PiratePhaseThreePatternsNormalHard.Random, --order);
        ...
        FlyingMermaidPhaseOneFirstPatternEasy = config.Bind("RNG Cala Maria", "P1 First Simple", FlyingMermaidPhaseOneFirstPatternsEasy.Random, --order);
        FlyingMermaidPhaseOneSecondPatternEasy = config.Bind("RNG Cala Maria", "P1 Second Simple", FlyingMermaidPhaseOneSecondPatternsEasy.Random, --order);
        FlyingMermaidPhaseOnePatternNormalHard = config.Bind("RNG Cala Maria", "P1 Regular/Expert", FlyingMermaidPhaseOnePatternsNormalHard.Random, --order);
        FlyingMermaidPhaseOneFishPattern = config.Bind("RNG Cala Maria", "P1 Fish", FlyingMermaidPhaseOneFishPatterns.Random, --order);
        FlyingMermaidPhaseOneSummonPattern = config.Bind("RNG Cala Maria", "P1 Summon", FlyingMermaidPhaseOneSummonPatterns.Random, --order);
        ...
        DevilClapDelay = config.Bind("RNG The Devil", "P1 Clap Delay (0.1-0.5, -1 for random)", -1f, --order);
        DevilPhaseOnePattern = config.Bind("RNG The Devil", "P1 Pattern", DevilPhaseOnePatterns.Random, --order);
        DevilPhaseOneHeadType = config.Bind("RNG The Devil", "P1 Head Type", DevilPhaseOneHeadTypes.Random, --order);
        DevilPhaseOneDragonDirection = config.Bind("RNG The Devil", "P1 Dragon Direction", DevilPhaseOneDragonDirections.Random, --order);
        DevilPhaseOneSpiderOffset = config.Bind("RNG The Devil", "P1 Spider Offset", DevilPhaseOneSpiderOffsets.Random, --order);
        DevilPhaseOneSpiderHopCount = config.Bind("RNG The Devil", "P1 Spider Hop Count", DevilPhaseOneSpiderHopCounts.Random, --order);
        DevilSpiderDelay = config.Bind("RNG The Devil", "P1 Spider Delay (0.3-0.7, -1 for random)", -1f, --order);
        DevilPhaseOnePitchforkType = config.Bind("RNG The Devil", "P1 Pitchfork Type", DevilPhaseOnePitchforkTypes.Random, --order);
        DevilPhaseOneBouncerAngleNormal = config.Bind("RNG The Devil", "P1 Bouncer Angle Regular", DevilPhaseOneBouncerAnglesNormal.Random, --order);
        DevilPhaseOneBouncerAngleHard = config.Bind("RNG The Devil", "P1 Bouncer Angle Expert", DevilPhaseOneBouncerAnglesHard.Random, --order);
        DevilPhaseTwoPatternNormal = config.Bind("RNG The Devil", "P2 Regular", DevilPhaseTwoPatternsNormal.Random, --order);
        DevilPhaseTwoPatternHard = config.Bind("RNG The Devil", "P2 Expert", DevilPhaseTwoPatternsHard.Random, --order);
        DevilPhaseTwoBombEyeDirection = config.Bind("RNG The Devil", "P2 Bomb Direction", DevilPhaseTwoBombEyeDirections.Random, --order);
        DevilPhaseThreeSkullPattern = config.Bind("RNG The Devil", "P3 Skull Parry", false, --order);
        ...
        SaltbakerPhaseOnePattern = config.Bind("RNG Chef Saltbaker", "P1 Pattern", SaltbakerPhaseOnePatterns.Random, --order);
        SaltbakerPhaseThreeSawPattern = config.Bind("RNG Chef Saltbaker", "P3 Saw Pattern", SaltbakerPhaseThreeSawPatterns.Random, --order);
#endif
