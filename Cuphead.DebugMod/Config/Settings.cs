...
public class Settings : PluginComponent {
    ...
    public static ConfigEntry<bool> DevilPhaseTwoHandStartPattern;
    ...
    public void Awake() {
        ...
        DevilPhaseTwoHandStartPattern = config.Bind("RNG The Devil", "Phase Three Skull Parry", false, --order);
